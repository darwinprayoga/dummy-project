        ...
        <div className="flex flex-col space-y-4">
          <div className="flex justify-between">
            ...
            <div className="space-x-2 hidden lg:inline-flex">
              <button className="aspect-square rounded-full bg-[#FAFAFA] hover:bg-[#3561FF]">
                <img src="/about-us/bi_arrow-left-short.png" alt="" />
              </button>
              <button className="aspect-square rounded-full bg-[#FAFAFA] hover:bg-[#3561FF]">
                <img src="/about-us/bi_arrow-right-short.png" alt="" />
              </button>
            </div>
          </div>
