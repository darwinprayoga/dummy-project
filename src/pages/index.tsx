    ...
    <main className={`bg-white ${inter.className}`}>
      ...
      <section id="our-work" className="space-y-4 py-12 px-24 md:h-1/2">
        ...
        <div className="flex justify-center h-1/2 py-4 lg:px-24 px-4">
          <div className="bg-[#3561FF] bg-[url('/elevate-your-brand/Background.png')] w-full rounded-2xl md:px-12 py-24 items-center flex flex-col md:flex-row space-y-8 md:space-y-0">
            ...
            <h1 className="text-5xl font-medium w-3/4 text-center md:text-left">Elevate Your Brand Today!</h1>
            </div>
            <div className="w-1/2 flex flex-col space-y-10 py-6">
              <p className="text-center md:text-left">Ready to transform your digital dresence? Let's create magic together! book our services now!</p>
              <button className="bg-white text-black rounded-xl p-2 md:w-1/2 lg:w-1/3">Book Now</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="w-full xl:space-x-0 space-x-4 flex justify-center py-24 flex-col-reverse lg:flex-row items-center lg:items-start">
        ...
        <div className="md:w-2/5 lg:space-y-24 xl:space-y-32 space-y-8 xl:py-4">
          <div className="space-y-12 h-1/2"><h1 className="text-black text-5xl xl:w-full font-semibold lg:text-left text-center">Meet Our Team</h1>
          <p className="text-slate-400 lg:text-left text-center lg:w-3/5">Discover the brilliance behind  Embrace. Our team blends innovation and artistry to craft digital wonders that captivate</p>
          </div>
          <div className="flex justify-center lg:justify-start py-8 md:py-0">
          <button className="bg-[#3461FF] rounded-full py-4 px-12 h-1/2 text-2xl">Learn more</button>
          </div>
        </div>
      </div>
      <div className="flex flex-col space-y-4">
        <div className="flex justify-between">
          <div><h1 className="text-black text-5xl font-semibold text-center lg:text-left">What Our Client Said About Us</h1></div>
          <div className="space-x-2 hidden lg:inline-flex">
            <button className="aspect-square rounded-full bg-[#FAFAFA] hover:bg-[#3561FF]"><img src="/about-us/bi_arrow-left-short.png" alt=""/>
              </button>
            <button className="aspect-square rounded-full bg-[#FAFAFA] hover:bg-[#3561FF]"><img src="/about-us/bi_arrow-right-short.png" alt="" />
              </button>
          </div>
        </div>
        <div className="flex md:flex-row flex-col justify-center space-y-4 space-x-0 md:space-x-4 md:space-y-0 w-full">
          <div className="bg-[#FAFAFA] hover:bg-[#3461FF] text-black hover:text-white transition duration-300 ease-in-out p-8 flex flex-col rounded-2xl md:w-3/5 space-y-2">
      ...
      <div className="w-screen h-1/2 flex justify-center">
          <div className="bg-[#232038] bg-[url('/start-your-journey/background.png')] w-3/4 rounded-2xl p-4 lg:p-8 flex flex-col md:flex-row space-y-8 md:space-y-0">
            ...
            <h1 className="text-3xl lg:text-5xl text-center md:text-left">Start Your Journey With Us Now</h1>
            <button className="bg-[#3461FF] rounded-full lg:py-4 lg:px-8 py-2 lg:text-xl text-md md:w-1/2">Start Now</button>
            </div>
        ...
        <div className="flex flex-col space-y-8 md:space-y-0 md:space-x-0 md:flex-row px-8 md:py-12 md:px-24">
          ...
          <div className="md:w-2/5 space-y-8 py-2 flex flex-col md:flex-none items-center md:items-start">
            ...
            <p className="text-slate-400 lg:w-2/5">Follow our newsletter. We will regularly update our latest project and availability</p>
            <div className="space-x-2 space-y-1">
              <input type="text" className="bg-[#FAFAFA] text-black form-input rounded-3xl pl-4 h-12" placeholder="Enter your email"/>
              <button className="text-white bg-[#3461FF] font-medium rounded-full h-12 px-8">Lets talk</button>
            </div>
      ...
      <section className="bg-[#FAFAFA] flex justify-between px-8 w-screen xl:px-24 py-12 md:px-12 md:py-8">
        <div className="w-1/2 space-y-12 md:space-y-8">
          ...
          <div className="flex justify-between w-36">
            ...
            <a href="facebook.com" className="hover:scale-105">
              <img src="/contact-us/facebook.png" alt="logo facebook" className="pt-1"/>
            </a>
          </div>
        ...
        <div className="text-black w-1/2 flex grid-rows-3 grid-cols-3 gap-1 font-semibold space-x-12">
          <div className="space-y-4">
            <ul className="hover:scale-105"><a href="">Work With Us</a></ul>
            <ul className="hover:scale-105"><a href="">Advertise With Us</a></ul>
            <ul className="hover:scale-105"><a href="">Support Us</a></ul>
            <ul className="hover:scale-105"><a href="">Business Advices</a></ul>
          </div>
          <div className="space-y-4">
            <ul className="hover:scale-105"><a href="">Private Coaching</a></ul>
            <ul className="hover:scale-105"><a href="">Our Work</a></ul>
            <ul className="hover:scale-105"><a href="">Our Commitment</a></ul>
            <ul className="hover:scale-105"><a href="">Our Team</a></ul>
          </div>
          <div className="space-y-4">
            <ul className="hover:scale-105"><a href="">About Us</a></ul>
            <ul className="hover:scale-105"><a href="">FAQs</a></ul>
            <ul className="hover:scale-105"><a href="">Report a Bug</a></ul>
          </div>
        </div>
      </section>
